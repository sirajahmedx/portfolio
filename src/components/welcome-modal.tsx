          ...
          >
            ...
            <DialogHeader className="relative flex flex-row items-start justify-between px-8 pt-8 pb-6">
              ...
              <Button
                variant="ghost"
                size="icon"
                className="bg-secondary text-secondary-foreground hover:bg-secondary/80 hover:text-secondary-foreground sticky top-0 right-0 cursor-pointer rounded-full p-2"
            ...
            <div className="flex flex-col items-center px-8 pt-4 pb-0 md:pb-8">
              ...
              >
                ...
                <div className="text-primary flex cursor-pointer items-center hover:underline">
                  Contact me.
                </div>
              </div>
            </div>
