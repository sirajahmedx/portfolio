...
export function Presentation() {
  ...
  const profile = {
    ...
    description:
      "Hey 👋\nI'm Siraj, a 16-year-old full-stack developer from Pakistan. I focus on building web and mobile applications, working on real-world projects, and learning new technologies. I enjoy keeping things simple, efficient, and professional, writing clean code, and solving challenging problems.",
    src: '/profil-siraj.png', // You'll need to add this image
    fallbackSrc:
    ...
    <div className="mx-auto w-full max-w-5xl py-6 font-sans">
      <div className="grid grid-cols-1 items-center gap-10 md:grid-cols-2">
        ...
        <div className="flex flex-col space-y">
          ...
          >
            {['Full-Stack Developer', 'React', 'Node.js', 'GraphQL', 'Mobile Apps'].map(
              (tag) => (
                <span
                  key={tag}
